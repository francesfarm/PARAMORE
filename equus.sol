...
contract EQUUSProtocol is IERC20, Staking {
   ...
   //Following the exact same method as before, stakes amount and burns 5% of amount, both functions update total supply per burning process
   ...
   //Function to return time using blocks
